document.addEventListener('DOMContentLoaded', function () {
    // 定義 flags 陣列
    const flags = [
        { src: "/Simulation_official_website/BWF/img/Flag_of_Chinese_Taipei_for_Olympic_Games.svg.webp", n: 0 },
        { src: "/Simulation_official_website/BWF/img/Flag_of_Denmark.svg.webp", n: 1 },
        { src: "/Simulation_official_website/BWF/img/Flag_of_Singapore.svg.webp", n: 2 },
        { src: "/Simulation_official_website/BWF/img/Flag_of_Thailand.svg.webp", n: 3 },
        { src: "/Simulation_official_website/BWF/img/Flag_of_the_People's_Republic_of_China.svg.webp", n: 4 },
        { src: "/Simulation_official_website/BWF/img/Flag_of_Japan.svg.webp", n: 5 }
    ];
    ...
    document.querySelectorAll('.team-logo-block').forEach(function (block) {
        ...
        function setLogoByIndex(idx) {
            ...
            preview.innerHTML = `<img src="/Simulation_official_website/BWF/img/${label}" style="width:32px;height:32px;">`;
